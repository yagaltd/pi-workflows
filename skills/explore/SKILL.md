...
Understand what the human needs to decide. `/explore` is for research, kill/pivot/proceed recommendations, and optional throwaway prototypes — not production planning.
